                    ...
                    <div class="col-md-6 permissions">
                        ...
                        @foreach($permissions as  $permission)
                            ...
                            <div
                                ...
                                <ul>
                                    <li data-value="1" class=" {{ isset($role->permissions[$permission]) && $role->permissions[$permission] == true ? 'active' : '' }} ">Allow</li>
                                    <li data-value="" class=" {{ !isset($role->permissions[$permission]) ? 'active' : '' }} ">Deny</li>
                                </ul>

                                <input type="hidden" name="permissions[{{ $permission }}]" value="{{ isset($role->permissions[$permission]) ? $role->permissions[$permission] : 'inherit' }}"/>
                            </div>
